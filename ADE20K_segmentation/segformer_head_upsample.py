...
class SegformerHead_Upsample(BaseDecodeHead):
    ...
    def forward(self, inputs):
        ...
        if self.upsample_mode == 'bilinear':
            ...
            x3 = resize(x3, size=x0.size()[2:], mode='nearest', align_corners=False)
            x2 = resize(x2, size=x0.size()[2:], mode='nearest', align_corners=False)
            x1 = resize(x1, size=x0.size()[2:], mode='nearest', align_corners=False)
        ...
        elif self.upsample_mode == 'defsampler':
