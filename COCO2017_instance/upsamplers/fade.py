...
class FADE(nn.Module):
    def __init__(self, in_channels_en, in_channels_de=None, scale_factor=2, up_kernel_size=5, gating=False):
    ...
    def forward(self, en, de):
        ...
        if self.gating:
            ...
            return gate * en + (1 - gate) * carafe(de, kernels, self.up_kernel_size, 1, self.scale_factor)
        else:
            return carafe(de, kernels, self.up_kernel_size, 1, self.scale_factor)
