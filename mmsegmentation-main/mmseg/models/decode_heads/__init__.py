...
from .ham_head_upsample import LightHamHead_Upsample
...
from .segformer_head_upsample import SegformerHead_Upsample
...
__all__ = [
    ...
    'SegformerHead_Upsample', 'LightHamHead_Upsample', 'ISAHead', 'STDCHead', 'IterativeDecodeHead',
